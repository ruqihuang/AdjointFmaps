function [mean_curv] = mean_curvature(X, T, W, Ae, smoothing_time)
	...
	% Parameters
	% ----------
	%           X                 :   (num_of_vertices x 3) 3D coordinates of the mesh vertices.
	%
	...
	%                                             
	%           smoothing         :  (k x 1, optional) Xector 
	%                                Xalues corresponding to time samples for the heat diffusion smoothing         
	%
	% Returns
	% -------
